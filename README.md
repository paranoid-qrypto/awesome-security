...
- [Integrity Auditor](https://github.com/paranoid-qrypto/integrity-auditor-tool) - 100% client-side tool for code comparison and file hash verification (MD5, SHA-256, SHA-512). Works offline.
